...
<div class="w3-row">
    <div class="w3-half w3-bar-block w3-center w3-padding" >
        <BUTTON class="w3-bar-item w3-button w3-margin w3-teal" TYPE=SUBMIT NAME='preview' value='pdf_cue_portrait'>PDF Cuesheet (portrait)</BUTTON">
            <BUTTON class="w3-bar-item w3-button w3-margin w3-teal" TYPE=SUBMIT NAME='preview' value='pdf_cue_landscape'>PDF Cuesheet (landscape)</BUTTON>
            <BUTTON class="w3-bar-item w3-button w3-margin w3-teal" TYPE=SUBMIT NAME='preview' value='csv_cue'>CSV Cuesheet</BUTTON>
</div>
<div class="w3-half w3-bar-block w3-center w3-padding" >

            <BUTTON class="w3-bar-item w3-button w3-margin w3-teal" TYPE=SUBMIT NAME='preview' value='card_inside'>Brevet Card Inside</BUTTON>
            <BUTTON class="w3-bar-item w3-button w3-margin w3-teal" TYPE=SUBMIT NAME='preview' value='card_outside_blank'>Brevet Card Outside Blank</BUTTON>
            <BUTTON class="w3-bar-item w3-button w3-margin w3-teal" TYPE=SUBMIT NAME='preview' value='card_outside_roster'>Brevet Card Outside Roster</BUTTON>
    </DIV>
...
<ul>
    ...
    <li>Last Published on: <?= $cuesheet_gentime_str ?></li>
</ul>
<div class="w3-bar-block w3-center" style="width: 50%; margin-left: 10%;">
